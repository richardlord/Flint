package org.flintparticles.integration.flare3d.v2.flare3dutils
{
    ...
    */
    public final class FQuaternion
    {
		 ...
		 */
		public function FQuaternion(x : Number = 0, y : Number = 0, z : Number = 0, w : Number = 1)
		{
			this.x = x;
			this.y = y;
			this.z = z;
        ...
        */
	    public function multiply(qa:FQuaternion, qb:FQuaternion):void
	    {
		...
		public function multiplyVector(vector : Vector3D, target : FQuaternion = null) : FQuaternion
		{
			target ||= new FQuaternion();
		 ...
		 */
		public function slerp(qa : FQuaternion, qb : FQuaternion, t : Number) : void
		{
			var w1 : Number = qa.w, x1 : Number = qa.x, y1 : Number = qa.y, z1 : Number = qa.z;
	        var w2 : Number = qb.w, x2 : Number = qb.x, y2 : Number = qb.y, z2 : Number = qb.z;
		 ...
		 * @param t The interpolation weight, a value between 0 and 1.
		 */
		public function lerp(qa : FQuaternion, qb : FQuaternion, t : Number) : void
		{
			var w1 : Number = qa.w, x1 : Number = qa.x, y1 : Number = qa.y, z1 : Number = qa.z;
			var w2 : Number = qb.w, x2 : Number = qb.x, y2 : Number = qb.y, z2 : Number = qb.z;
			var len : Number;
        ...
        */
		...
		{
			var rawData : Vector.<Number> = new Vector.<Number>(16);///Matrix3DUtils.RAW_DATA_CONTAINER;
		 ...
		 */
		public function clone() : FQuaternion
		{
		 ...
		 */
		public function copyFrom(q : FQuaternion) : void
		{
			x = q.x;
			y = q.y;
			z = q.z;
